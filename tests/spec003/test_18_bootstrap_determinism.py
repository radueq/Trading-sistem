...
def test_same_seed_same_input_produces_identical_replicates():
    ...
    r1 = time_block_bootstrap_replicates(dated, session_dates, block_length_bars=5, iterations=300, seed=7)
    r2 = time_block_bootstrap_replicates(dated, session_dates, block_length_bars=5, iterations=300, seed=7)
    assert r1 == r2
...
def test_different_seed_can_produce_different_replicates():
    ...
    session_dates = [d for d, _ in dated]
    r1 = time_block_bootstrap_replicates(dated, session_dates, block_length_bars=5, iterations=300, seed=7)
    r2 = time_block_bootstrap_replicates(dated, session_dates, block_length_bars=5, iterations=300, seed=8)
    assert r1 != r2
